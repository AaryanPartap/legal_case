...
// Import the new Earnings Screen
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (_) => const ActiveCasesScreen()),
                    ),
                  ...
                  GestureDetector(
                    onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (_) => const ScheduleViewScreen()),
                    ),
                    child: _actionCard('Schedule', Icons.calendar_month),
                  ),
                  // FIX: Added GestureDetector to navigate to EarningsScreen
                  GestureDetector(
                    onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(
